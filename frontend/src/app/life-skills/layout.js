export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Real-world knowledge for Kenyan students. Money, relationships, safety, health, citizenship, and your future.",
    url: "https://stadispace.co.ke/life-skills",
  },
};

export default function LifeSkillsLayout({ children }) {
  return children;
}
