...
const  SYMBOL_LIBRARY = {
  ...
  Physics: [
    ...
    {
      label: "\u03B7 = P\u2092\u1D64\u209C/P\u1D62\u2099",
      value: "\\eta=\\frac{P_{out}}{P_{in}}\\times100\\%",
    },
    ...
    {
      label: "n\u2081sin\u03B8\u2081 = n\u2082sin\u03B8\u2082",
      value: "n_{1}\\sin\\theta_{1}=n_{2}\\sin\\theta_{2}",
    },
    { label: "sin C = 1/n", value: "\\sin C=\\frac{1}{n}" },
    {
      label: "1/f = 1/u + 1/v",
      value: "\\frac{1}{f}=\\frac{1}{u}+\\frac{1}{v}",
    },
    ...
    {
      label: "t\u00BD = ln2/\u03BB",
      value: "t_{\\frac{1}{2}}=\\frac{\\ln 2}{\\lambda}",
    },
