...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <Toast message={error} type="error" visible={showToast} onClose={() => setShowToast(false)} />
        ...
        <div className="hidden lg:flex lg:w-[45%] hero-bg relative overflow-hidden flex-col justify-between p-12">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div className="leading-none">
              <span className="font-display text-lg font-bold text-white block">CBC Kenya</span>
              <span className="text-[10px] font-semibold text-green-400 tracking-widest uppercase block">Learning Platform</span>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-white/80 text-xs font-semibold tracking-wide uppercase">Grades 4–10 • AI Marking</span>
            </div>
            <h2 className="font-display text-5xl text-white leading-[1.1] mb-6">
              Welcome<br />back to<br /><span className="text-amber-400">greatness.</span>
            </h2>
            <p className="text-green-200 text-base leading-relaxed max-w-xs">
              Your progress is waiting. Every session brings you closer to the top of your class.
            </p>

            {/* Mini stats */}
            <div className="mt-10 grid grid-cols-3 gap-4">
              {[["12K+", "Students"], ["94%", "Improve"], ["50K+", "Daily Qs"]].map(([val, label]) => (
                <div key={label} className="bg-white/10 backdrop-blur rounded-2xl p-4 border border-white/10">
                  ...
                  <p className="text-green-300 text-xs font-medium mt-0.5">{label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative bg-white/10 backdrop-blur border border-white/15 rounded-2xl p-5">
            ...
            <p className="text-white/90 text-sm italic leading-relaxed mb-3">"My son improved from 61% to 89% in one term. Absolutely worth it."</p>
            <p className="text-green-300 text-xs font-semibold">— Wanjiru M., Parent · Nairobi</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gray-50">
          ...
          >
            ...
            <div className="lg:hidden flex items-center gap-2.5 mb-8">
              ...
              <span className="font-display text-lg font-bold text-green-900">CBC Kenya</span>
            </div>

            <div className="mb-8">
              <h1 className="font-display text-4xl text-gray-900 mb-2">Sign In</h1>
              <p className="text-gray-500 text-sm">Don't have an account?{" "}
                <Link href="/register" className="font-semibold text-green-700 hover:text-green-800">Create one free</Link>
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <Link href="/forgot-password" className="text-xs font-semibold text-green-700 hover:text-green-800">Forgot password?</Link>
                  </div>
                  <div className="relative">
                    <input
                ...
                <button
                  ...
                  style={{ background: loading ? "#16a34a" : "linear-gradient(135deg, #15803d, #059669)" }}
                >
                  {loading ? (
            ...
            <p className="text-center text-xs text-gray-400 mt-6">
              ...
              <a href="#" className="text-green-700 hover:underline">Terms</a> &{" "}
